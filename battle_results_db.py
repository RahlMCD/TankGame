...
def write_results():
    ...
    panzer_defensive = [(panzer[0],'Front Armor'), (panzer[1],'Left Side Armor'), (panzer[2],'Right Side Armor' ), (panzer[3],'Back Side Armor')]
    ...
    t34_defensive_stats = [(t34[0],'Front Armor'), (t34[1],'Left Side Armor'), (t34[2],'Right Side Armor' ), (t34[3],'Back Side Armor' )]
